...
//  质量图初始化显示
    ...
    private void showFileDetails() {
        ...
        Label heightLabel    = new Label("• Rows: " + KMCG_canvas_height);
        Label widthLabel     = new Label("• Columns: " + KMCG_canvas_width);
    ...
    public void handleAbout(ActionEvent event) {
        ...
        alert.setContentText("Version: 3.2\n\n" +
